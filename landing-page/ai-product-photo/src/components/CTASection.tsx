        ...
        <VStack spacing={12} textAlign="center">
          <Box>
            <Heading
              ...
              lineHeight="1.1"
            >
              Start Using <Text as="span" bgGradient="linear(to-r, #FF6B6B, #805AD5, #4ECDC4)" bgClip="text">AI Product Photo Today</Text>
            </Heading>
            
            <VStack spacing={4}>
              <Text color="gray.300" fontSize={{ base: "lg", md: "xl" }} fontWeight="medium">
                Create high-quality product photos that work for marketing, ecommerce, and advertising.
              </Text>
            </VStack>
          </Box>
