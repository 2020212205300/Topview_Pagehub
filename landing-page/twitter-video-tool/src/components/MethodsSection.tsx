        ...
        <VStack spacing={12} align="center" textAlign="center">
          <Box maxW="4xl">
            <Heading as="h2" size={{ base: "2xl", md: "4xl" }} fontWeight="black" mb="6" color="white" lineHeight="1.1">
              Viral <Text as="span" bgGradient="linear(to-r, #FF6B6B, #805AD5, #4ECDC4)" bgClip="text">Twitter Video</Text> Templates
            </Heading>
            ...
            <Text fontSize={{ base: "lg", md: "xl" }} color="gray.400" maxW="3xl" mx="auto">
              Topview includes ready-to-use Twitter video templates based on real high-performing content.
            </Text>
          </Box>
