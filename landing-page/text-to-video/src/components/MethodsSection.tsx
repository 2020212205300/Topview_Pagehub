      ...
      <Container maxW="container.xl">
        <VStack spacing={12} align="center" textAlign="center">
          <Box maxW="4xl">
            ...
            <Text fontSize="lg" color="whiteAlpha.900" mb={6} fontWeight="bold">
