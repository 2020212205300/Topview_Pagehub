      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Video advertising has become the most powerful tool in digital marketing. 
            Learn how AI is transforming video ad creation, making professional-quality 
            ads accessible to businesses of all sizes.
          </p>
...
export default AdvertisingHeroV2;
